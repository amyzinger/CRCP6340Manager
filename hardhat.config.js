...
const ALCHEMY_URL = `https://polygon-amoy.g.alchemy.com/v2/${ALCHEMY_API_KEY}`; //changed from Mumbai to Amoy
// const ALCHEMY_URL = `https://polygon-mumbai.g.alchemy.com/v2/${ALCHEMY_API_KEY}`; MUMBAI DEPRECATED
...
module.exports = {
  etherscan: {
    apiKey: {
      ...
      polygonAmoy: POLYGONSCAN_API_KEY, //changed from Mumbai to Amoy
    },
  },
  gasReporter: {
  ...
  networks: {
    ...
    polygonAmoy: {  //changed from Mumbai to Amoy
      url: ALCHEMY_URL,
